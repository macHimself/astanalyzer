...
individual finding is displayed as a collapsible card with two levels of detail.
...
Each level is collapsible, allowing users to quickly navigate thousands of findings.
